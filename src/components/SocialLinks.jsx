...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/lucky-kumar-3a4630289/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@thatsluckyy_",
    icon: Instagram,
    url: "https://www.instagram.com/thatsluckyy_",
    color: "#E4405F",
  ...
  },
  {
    ...
    displayName: "Youtube",
    icon: Youtube,
    url: "https://www.youtube.com/@thatsluckyy__",
    color: "#FF0000",
  ...
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "Luckyraj9295",
    icon: Github,
    url: "https://github.com/luckycodebase",
    color: "#ffffff",
...
const SocialLinks = () => {
  ...
  const [instagram, youtube, github, geeksforgeeks] = otherLinks;
...
>
  ...
  >
    <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/10 to-transparent
        ...
        {/* Third Row - GitHub & GeeksForGeeks */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {[github, geeksforgeeks].map((link) => (
            <a
              key={link.name}
              href={link.url}
              target="_blank"
